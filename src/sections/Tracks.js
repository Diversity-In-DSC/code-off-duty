...
class Tracks extends Component {
  constructor(props) {
    ...
    Array.prototype.push.apply(this.state.trackVisible, [
      false,
      false,
      false,
      false,
    ...
    this.tracks = [
      {
        ...
        show: false,
        color: "#F4B400",
        c: this.state.device === "xs" ? "track-ARVR" : "track-ARVR ml-4",
        image: (
          <ARVRlogo
            style={{
      ...
      >
        <Row className="mx-5 align-items-center mt-4">
          <Col
            ...
            onClick={() => {
              this.props.goBack(
                this.state.device === "xs" ? "mobile-tracks" : "tracks"
              );
            }}
          >
            <svg
        ...
        <Row className="justify-content-center">
          {this.tracks.map((track, index) => (
            <Col xl={2} className="pl-5" key={index}>
              <div
                style={{
                  boxShadow: "0 1px 10px #888",
                  position: "fixed",
                  top: "-10em",
                  left: this.state.device === "xs" ? "8em" : "",
                  cursor: "pointer",
                  background: "#fff",
                  borderRadius: "50%",
                  display: "flex",
                  width: this.state.device === "xs" ? "8em" : "10em",
              ...
              >
                <div className="track-img text-center">
                  ...
                  <h4
                    style={{
                      color: "black",
                      fontSize: this.state.device ? 10 : 15,
