    ...
    return (
      <Container fluid className="fixed-top px-5" style={this.props.style} id="info-section">
        ...
        <Row>
         ...
         <Card.Body><p><b>CODE-OFF-DUTY</b> is an event of <b>DSC WOW</b>, where innovaters get an opportunity to merge their creative ideas 
           with their coding skills to build something exemplary. It's a place where your ideas will get acknowledeged.</p>
           Expect more than 36 hrs of inspiring panel discussion,working and collaborating on futuristic and empowering tech products, networking 
           opportunities with budding developers and lots of fun!
         </Card.Body>
         </Card>
        </Row>
        <Row className="justify-content-center justify-content-around mt-5">
          ...
          <Col className="mb-5 mb-xl-0 "
            ...
            {eligibilityAndRules.eligibility.map((rule, index) => <Row className="mb-3 px-4" key={index}>
              <h6 className="text-white">{rule.rule}</h6>
            </Row>)}
          </Col>
        </Row>
      </Container> 
