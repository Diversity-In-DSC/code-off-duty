      ...
      <Container fluid className="fixed-top px-5" style={this.props.style} id="info-section">
        ...
        <Row>
          <Card className="bg-transparent text-white p-4" style={{border: "none"}}>
            <Card.Body><p style={{fontSize: 20}}><b>CODE-OFF-DUTY</b> is an event of <b>DSC WOW</b>, where innovators
              get an opportunity to merge their creative ideas
              with their coding skills to build something exemplary. It's a place where your ideas will get
              acknowledged.</p>
              <p style={{fontSize: 20}}>Expect more than 36 hrs of inspiring panel discussion,working and collaborating
                on futuristic and empowering tech products, networking
                opportunities with budding developers and lots of fun!</p>
            </Card.Body>
          </Card>
        </Row>
